...
/**
 * @see <a href=
 *      "https://github.com/DiscoveryGC/FLHook/blob/3817c575c9584fd3c7f572af9d2c0ac0f4bf62eb/Plugins/Public/playercntl_plugin/setup_src/FLUtility.cs#L111">Reference</a>
 */
public class IdUtil {
  private static final int FLHASH_POLYNOMIAL = 0xA001;
  private static final int LOGICAL_BITS = 32;
  private static final int PHYSICAL_BITS = 30;
  ...
  public static int generate(String string) {
    int id = 0;
    byte[] bytes = string.toLowerCase().getBytes();
